...
if __name__ == "__main__":
    ...
    regressor = Ridge()
    params = {
        'alpha': [3.0, 3.2, 3.4, 3.6, 3.8, 4.0, 4.2, 4.4, 4.6, 4.8, 5.0]
        }
    cv = int(args.cv)
    model = GridSearchCV(regressor, param_grid = params, cv = cv, verbose = 0)
    ...
    with mlflow.start_run() as run:
        ...
        mlflow.sklearn.log_model(
            ...
            registered_model_name="RidgeCV_car_rental_price_predictor",
